...
% ReceiveFactory - CSRD MATLAB declaration.
    ...
    methods (Access = protected)
        ...
        function receivedDataStruct = stepImpl(obj, inputSignalStruct, frameId, rxInfoThisRx, receiverScenarioConfig)
            ...
            try
                ...
                if isprop(currentReceiverBlock, 'SampleRateOffsetInfo')
                    receivedDataStruct.RxImpairments.SampleRateOffsetInfo = ...
                        currentReceiverBlock.SampleRateOffsetInfo;
                else
                    receivedDataStruct.RxImpairments.SampleRateOffsetInfo = struct( ...
                        'Applied', false, ...
                        'OffsetPpm', 0, ...
                        'InputSamples', size(processedSignal, 1), ...
                        'OutputSamples', size(processedSignal, 1), ...
                        'Action', 'unavailable');
                end
