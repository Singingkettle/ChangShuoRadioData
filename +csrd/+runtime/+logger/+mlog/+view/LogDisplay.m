classdef LogDisplay < matlab.ui.componentcontainer.ComponentContainer
    ...
    properties (AbortSet)
        ...
        % Logger to monitor
        Log csrd.runtime.logger.mlog.Logger {mustBeScalarOrEmpty}

        % Most severe level of messages to display
        UpperDisplayThreshold (1,1) csrd.runtime.logger.mlog.Level = csrd.runtime.logger.mlog.Level.NONE

        % Least severe level of messages to display
        LowerDisplayThreshold (1,1) csrd.runtime.logger.mlog.Level = csrd.runtime.logger.mlog.Level.INFO
    ...
    methods (Access = protected)
        ...
        function update(obj)
            ...
            if ~isempty(obj.Log) && isvalid(obj.Log)
                ...
                messages = csrd.runtime.logger.mlog.Message.empty(0,1);
            end
