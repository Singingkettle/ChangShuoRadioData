classdef Logger < handle & matlab.mixin.SetGetExactNames & ...
    ...
    properties (AbortSet)
        ...
        RotationPeriod (1,1) csrd.runtime.logger.mlog.RotationPeriod = csrd.runtime.logger.mlog.RotationPeriod.none

        % Level of messages to save to the log file
        FileThreshold (1,1) csrd.runtime.logger.mlog.Level = csrd.runtime.logger.mlog.Level.INFO

        % Level of messages to display in the command window
        CommandWindowThreshold (1,1) csrd.runtime.logger.mlog.Level = csrd.runtime.logger.mlog.Level.WARNING

        % Level of messages to trigger MessageReceived event notification
        MessageReceivedEventThreshold (1,1) csrd.runtime.logger.mlog.Level = csrd.runtime.logger.mlog.Level.MESSAGE
    ...
    properties (Dependent, SetObservable, SetAccess = protected)
        ...
        % Log message history
        Messages (:,1) csrd.runtime.logger.mlog.Message
    ...
    properties (Dependent, SetAccess = protected)
        ...
        LastMessage (:,1) csrd.runtime.logger.mlog.Message
    ...
    properties (Access = protected)
        ...
        MessageBuffer (:,1) csrd.runtime.logger.mlog.Message = repmat(csrd.runtime.logger.mlog.Message, 1000, 1)
        ...
        MessageConstructor (1,1) function_handle = @csrd.runtime.logger.mlog.Message
    ...
    methods (Sealed, Access = private)
        ...
        function obj = getSingletonLogger(obj,name)
            ...
            if isempty(AllLoggers)
                AllLoggers = csrd.runtime.logger.mlog.Logger.empty(0);
            end
    ...
    methods (Static)
        ...
        function obj = loadobj(s)
            ...
            if isstruct(s)
                ...
                obj = csrd.runtime.logger.mlog.Logger(s.Name, s.LogFile);
            else
                obj = s;
            end
