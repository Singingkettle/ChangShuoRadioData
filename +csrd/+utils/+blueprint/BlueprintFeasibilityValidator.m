classdef BlueprintFeasibilityValidator < handle
    ...
    %
    % See also: csrd.utils.blueprint.computeBlueprintHash
    ...
    methods (Static)
        ...
        function report = validate(blueprint)
            ...
            checkList = {
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkFrameSampleConsistency
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkRxFsEqualsObservableBw
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkTxBwInsideRxWindow
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkModulationAntennaCompatible
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkRFImpairmentRange
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkBurstTotalDurationFits
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkCrossFrameSegmentMinSamples
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkOsmFileExistsAndBuildings
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkChannelModelInRegistry
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkTrajectoryMonotonicAndCovers
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkLinkDistanceAboveMin
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkMemoryBudget
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkReceiverViewProjectionPresent
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkBurstOverlapsFrameExpansion
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkMeasurementPlanesSeparated
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkGeometryGranularityDeclared
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkReceiverOutputWindowConsistent
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkOverlapAnnotationConsistent
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkMeasurementCompleteness
                @csrd.utils.blueprint.BlueprintFeasibilityValidator.checkDopplerSelfConsistency
            };

            failures = csrd.utils.blueprint.BlueprintFeasibilityValidator.emptyFailureArray();
            ...
            report = struct( ...
                ...
                'WarnChecks',      warns, ...
                'Provenance',      struct( ...
                    'ValidatorVersion', csrd.utils.blueprint.BlueprintFeasibilityValidator.ValidatorVersion, ...
        ...
        function failure = checkFrameSampleConsistency(blueprint)
            failure = csrd.utils.blueprint.BlueprintFeasibilityValidator.emptyFailure();
            ...
            for i = 1:numel(rx)
                ...
                if abs(expected - frameNumSamples) > 1
                    failure = csrd.utils.blueprint.BlueprintFeasibilityValidator.makeFailure( ...
        ...
        function failure = checkModulationAntennaCompatible(blueprint)
            ...
            try
                matrixProfile = csrd.utils.profile.profileLoader('antennaCompat', ...
