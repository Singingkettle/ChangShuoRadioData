...
%       csrd.utils.scenario.findOverlappingTransmissionIntervals(frameId, pattern)
%
%   Inputs (mirrors csrd.utils.scenario.checkTransmissionInterval):
...
%                             (the original [startTime, endTime] pairs).
