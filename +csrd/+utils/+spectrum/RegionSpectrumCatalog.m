classdef RegionSpectrumCatalog
    ...
    methods (Static)
        ...
        function catalogs = loadAll()
            ...
            for k = 1:numel(ids)
                catalogs{k} = csrd.utils.spectrum.RegionSpectrumCatalog.load(ids{k});
            end
        end
            ...
            switch regionId
                ...
                otherwise
                    error('CSRD:Spectrum:UnsupportedRegion', ...
                        ...
                        regionId, strjoin(csrd.utils.spectrum.RegionSpectrumCatalog.supportedRegionIds(), ', '));
            end
            csrd.utils.spectrum.RegulatoryValidator.validateCatalog(catalog);
        end
    end
end
