classdef ASK < blocks.physical.modulate.digital.APSK.APSK
    % FILEPATH: ChangShuoRadioData/csrd/modulate/digital/ASK/ASK.m
    %
    % ASK class is a subclass of APSK class and represents an Amplitude Shift Keying (ASK) modulate.
    %
    % Methods:
