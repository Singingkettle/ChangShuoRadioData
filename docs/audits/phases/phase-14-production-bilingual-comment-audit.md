...
- Generated manifest / 生成型审计清单：
  - Not committed after Phase 19. Regenerate with
    `csrd.support.docs.auditProductionComments('WriteManifest', true)`.
  - Phase 19 default output:
    `artifacts/audits/reports/phase-14-production-comment-audit.json`
