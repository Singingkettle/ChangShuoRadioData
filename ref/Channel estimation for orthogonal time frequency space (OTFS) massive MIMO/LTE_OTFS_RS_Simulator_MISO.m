function [NMSE_Impulse,NMSE_Bernoul_OMP,NMSE_Bernoul_StrucOMP] = LTE_OTFS_RS_Simulator_MISO(SNR,eta,NumBSelement)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Num_Pilot_v = Num_OFDM_symbol_per_TTI;
% tao_max=1.2e-6;
tao_max = 4.5e-6;
