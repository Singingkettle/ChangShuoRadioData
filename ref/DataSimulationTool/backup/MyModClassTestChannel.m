classdef MyModClassTestChannel < matlab.System
...
%   Copyright 2018 The MathWorks, Inc.
  ...
  properties (Nontunable)
    ...
    %   method to generate a new channel realization. TheChannel
  ...
  methods
    function obj = MyModClassTestChannel(varargin)
  ...
  methods(Access = protected)
    function setupImpl(obj)
        if strcmp(obj.channel_type, 'rayleigh')
            obj.Channel = comm.RayleighChannel( ...
                  'SampleRate', obj.SampleRate, ...
                  'PathDelays', obj.PathDelays, ...
                  'AveragePathGains', obj.AveragePathGains, ...
                  'MaximumDopplerShift', obj.MaximumDopplerShift);
        elseif strcmp(obj.channel_type, 'rician')
            obj.Channel = comm.RicianChannel(...
            'SampleRate', obj.SampleRate, ...
            'PathDelays', obj.PathDelays, ...
            'AveragePathGains', obj.AveragePathGains, ...
            'KFactor', obj.KFactor, ...
    ...
    function y = stepImpl(obj,x)
      ...
      if strcmp(obj.channel_type, 'rayleigh') || strcmp(obj.channel_type, 'rician')
          y = addMultipathFading(obj,x);
          y = addClockOffset(obj, y);
          y(isnan(y)) = 0;
      else
          y = x;
      end
      if ~strcmp(obj.channel_type, 'clean')
          y     = addNoise(obj, y);
      end
    end
