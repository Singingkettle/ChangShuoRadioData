...
for i=1:70000
%     s = clock;
    fprintf('Under mix rayleigh channel, generate data of number %05d.\n', i);
    ...
    if ~isempty(y)
        ...
        fid = fopen(sprintf("./v25/anno/%06d.json", i),'w');
        fprintf(fid, s); 
        fclose(fid);
    
        save(sprintf("./v25/sequence_data/iq/%06d.mat", i),  'signal_data');
    end
end