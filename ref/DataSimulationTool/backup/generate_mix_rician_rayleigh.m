...
channel_rayleigh = MyModClassTestChannel(...
                        ...
                        'MaximumClockOffset', 5, ...
                        'CarrierFrequency', 902e6);
channels = {channel_rician, channel_rayleigh};
snrs = 0:5:30;

for i=1:70000
%     s = clock;
    fprintf('Under mix rician and rayleigh channel, generate data of number %05d.\n', i);
    ...
    if ~isempty(y)
        ...
        fid = fopen(sprintf("./v26/anno/%06d.json", i),'w');
        fprintf(fid, s); 
        fclose(fid);
    
        save(sprintf("./v26/sequence_data/iq/%06d.mat", i),  'signal_data');
    end
end