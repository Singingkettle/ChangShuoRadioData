classdef whiteGaussian < matlab.System
%Channel Test channel for modulation classification
%   CH = Channel creates an channel System object, CH.
%   This object adds multipath fading, clock offset effects, and white
%   Gaussian noise to a framed signal.
%   
%   CH = Channel(Name,Value) creates a channel object,
...
%   Copyright 2018 The MathWorks, Inc.
  ...
  methods
    function obj = whiteGaussian(channelParam)
      % Support name-value pair arguments when constructing object
      obj.SNR = channelParam.snr;
      obj.CarrierFrequency = channelParam.centerFrequency;
      obj.SampleRate = channelParam.sampleRate;
      obj.PathDelays = channelParam.pathDelays;
      obj.AveragePathGains = channelParam.averagePathGains;
      obj.KFactor = channelParam.kfactor;
      obj.MaximumDopplerShift = channelParam.maximumDopplerShift;
      obj.MaximumClockOffset = channelParam.maximumClockOffset;
    end
  end
