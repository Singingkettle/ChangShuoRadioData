...
params_lists(47, 2) = 1.3;%1.5;
params_lists(57, 2) = 1.6;%2;
...
for SNR_set = SNR
    for i = 1:transmitterargs.num        % 遍历12种发射机参数
        ...
        sigargs.format.output = "seq";% pic
        sigargs.format.preprocess = "RI";% density % constellation
