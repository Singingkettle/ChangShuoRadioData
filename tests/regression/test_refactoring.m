                ...
                if isstruct(ann) && isfield(ann, 'Status')
                    ...
                    if isfield(ann, 'SignalSources') && ~isempty(ann.SignalSources)
                        ...
                        if isfield(src, 'Truth') && isfield(src.Truth, 'Design') && ...
                                ...
                                isfield(src.Truth.Design, 'AllocatedBandwidthHz') && ...
