classdef BuildSourceAnnotationTest < matlab.unittest.TestCase
    %BUILDSOURCEANNOTATIONTEST Phase 4 §5 / S5 v2 schema contract.
    %
    ...
    properties (Constant, Access = private)
        ...
        ExpectedDesignFields = { ...
            'PlannedCenterFrequencyHz', 'AllocatedBandwidthHz', ...
            'PlannedSampleRate', 'ModulationFamily', ...
            'ModulationOrder', 'MessageSource', 'IsDigital', ...
            'PayloadLengthBits', ...
    ...
    methods (Test)
        ...
        function truthDesignBlockComplete(testCase)
            ...
            for k = 1:numel(sources)
                ...
                testCase.verifyGreaterThan(d.AllocatedBandwidthHz, 0, ...
                    sprintf('Source %d AllocatedBandwidthHz must come from Blueprint.', k));
