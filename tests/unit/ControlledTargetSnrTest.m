classdef ControlledTargetSnrTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function awgnControlledSnrIsDeterministicAndInBand(testCase)
            ...
            realizedDb = 10 * log10(out1.ChannelSignalPowerW / out1.RequestedChannelNoisePowerW);
        ...
        function noiseFreeChannelInjectionRealizesTargetSnr(testCase)
            ...
            testCase.verifyTrue(isfield(out, 'RequestedChannelNoisePowerW') && ...
                out.RequestedChannelNoisePowerW > 0, ...
                'Injection must establish a channel-noise floor for fading.');
            realizedDb = 10 * log10(out.ChannelSignalPowerW / out.RequestedChannelNoisePowerW);
