classdef SanitizeForJsonBasicTest < matlab.unittest.TestCase
    ...
    %rules in csrd.pipeline.annotation.sanitizeForJson.
    %
    ...
    methods (Test)
        ...
        function nanScalarBecomesStringWhenPolicyIsString(testCase)
            ...
            [clean, manifest] = csrd.pipeline.annotation.sanitizeForJson(NaN, opts);
        ...
        function positiveInfBecomesNull(testCase)
            [clean, manifest] = csrd.pipeline.annotation.sanitizeForJson(Inf);
        ...
        function datetimeBecomesIso8601(testCase)
            ...
            [clean, manifest] = csrd.pipeline.annotation.sanitizeForJson(dt);
        ...
        function durationBecomesSeconds(testCase)
            d = duration(0, 5, 30);
            [clean, manifest] = csrd.pipeline.annotation.sanitizeForJson(d);
