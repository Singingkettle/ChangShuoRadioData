...
frameDuration = cfg.Global.FrameNumSamples / cfg.Receiver.SampleRate;
cfg.RuntimePlan.Frame = struct( ...
    'FrameNumSamples', cfg.Global.FrameNumSamples, ...
    'FrameDurationSec', frameDuration, ...
    'ObservationDurationSec', frameDuration * cfg.Global.NumFramesPerScenario, ...
    'NumFramesPerScenario', cfg.Global.NumFramesPerScenario);
end
