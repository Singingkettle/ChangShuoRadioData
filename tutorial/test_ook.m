...
ModulationConfig.Radii = [0.3 0.7 1.2];
ModulationConfig.PhaseOffset = [0 0 0];
ModulationConfig.beta = 0.35;
ModulationConfig.span = 4;
...
baseBandSignal = OOK(SampleRate=SampleRate, ...
    TimeDuration=TimeDuration, ...
    ModulationOrder=ModulationOrder, ...
    SamplePerSymbol=SamplePerSymbol, ...
