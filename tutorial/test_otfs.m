...
ModulatorConfig.otfs.padLen = 10;
ModulatorConfig.otfs.padType = 'ZP';
ModulatorConfig.otfs.DelayLength = 128;
ModulatorConfig.otfs.Subcarrierspacing = 10e3;
...
rxRF = RRFSimulator(StartTime=0, TimeDuration=2, SampleRate=2.5e6, ...
    NumReceiveAntennas=1, CarrierFrequency=200e3, Bandwidth=2000e3, ...
    MasterClockRate=MasterClockRate, ...
    MemoryLessNonlinearityConfig=MemoryLessNonlinearityConfig, ...
...
baseBandSignal = OTFS(SampleRate = SampleRate, ...
    TimeDuration = TimeDuration, ...
    ModulatorOrder=ModulatorOrder, ...
