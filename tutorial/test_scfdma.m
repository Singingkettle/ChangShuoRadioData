...
ModulatorConfig.scfdma.Subcarrierspacing = 10e3;
ModulatorConfig.scfdma.NumDataSubcarriers = 24;
ModulatorConfig.scfdma.SubcarrierMappingInterval = 3;
...
baseBandSignal = SCFDMA(SampleRate=SampleRate, ...
    TimeDuration=TimeDuration, ...
    ModulatorOrder=ModulatorOrder, ...
